...
public class JiNianRiUtils {
    ...
    public static int getLianAi(){
        return calculationLianAi("2017-09-29");
    }
    public static int getBirthday_Liu(){
        try {
            return calculationBirthday("2000-11-20");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return 0;
    }
    public static int getBirthday_Wang(){
        try {
            return calculationBirthday("2000-03-04");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return 0;
